...
$(build_release_make):
	mkdir -p $(@D)
	cd $(@D) && cmake -G"Unix Makefiles" -DCMAKE_BUILD_TYPE=Release -DCMAKE_TOOLCHAIN_FILE=stm32_toolchain.cmake ../..
...
$(build_debug_make):
	mkdir -p $(@D)
	cd $(@D) && cmake -G"Unix Makefiles" -DCMAKE_BUILD_TYPE=Debug -DCMAKE_TOOLCHAIN_FILE=stm32_toolchain.cmake ../..
